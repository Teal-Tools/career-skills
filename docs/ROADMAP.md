...
**All 17 skills are built and carry Teal's methodology** (15 as of 2026-07-06;
`teal-mcp` added 2026-07-10 with the v0.1.0 tag; `giving-feedback` added 2026-07-20
with the v0.2.0 tag). Nothing in the inventory is a stub.
